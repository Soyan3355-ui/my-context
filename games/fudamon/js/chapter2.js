...
const RIVAL={
  rv2:{map:'valley',at:(x,y)=>y===6&&x>=4&&x<=12,team:()=>[{id:rivalStarter(),lv:16},{id:16,lv:14}],pre:['よう ソーヤ！ やっと 追いついたな！','霧の 谷で 腕試しだ！ いくぜ！'],win:'くっ… 谷の 霧で 前が 見えなかった だけだ！',lose:'へへっ、おれの 勝ち！<br>先に 行ってるぜ！',post:'同じ 札を 集めて レベルを 上げると 進化するんだ。<br>おまえも 相棒を 進化させてみろよ！'},
  rv3:{map:'mount',at:(x,y)=>y===12&&x>=10&&x<=22,team:()=>[{id:EVO[rivalStarter()].to,lv:21},{id:17,lv:19},{id:14,lv:20}],pre:['ソーヤ！ 見ろよ、おれの 相棒！<br>ついに 進化したんだぜ！','熱い 山には 熱い 勝負が お似合いだ！'],win:'進化しても 勝てないなんて… おまえ、どこまで 強くなるんだ。',lose:'進化の 力、思い知ったか！',post:'月影の森の 先に… あのクジラの 手がかりが あるらしいぜ。'},
