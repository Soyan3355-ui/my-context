...
(function () {
  ...
  const HOME = [
    ...
    { id: 'mask', name: 'マスク', full: 'マスク・ド・ハマ', pos: 'DF', age: '??', job: '覆面レスラー（たぶん魚屋）', stats: { spd: 36, sht: 44, pas: 30, def: 60, sta: 62 },
    ...
    { id: 'kawataro', name: 'カワタロウ', full: '川田 カワタロウ', pos: 'DF', age: 31, job: '川漁協の職員', stats: { spd: 46, sht: 30, pas: 40, def: 58, sta: 60 },
    ...
    { id: 'shizuku', name: 'シズク', full: '水無月 シズク', pos: 'MF', age: 18, job: '神社の娘', stats: { spd: 50, sht: 36, pas: 52, def: 50, sta: 50 },
    ...
    { id: 'mame', name: '豆じい', full: '豆蔵 じい', pos: 'MF', age: 82, job: '盆栽職人', stats: { spd: 18, sht: 40, pas: 78, def: 34, sta: 26 },
    ...
    // bench
    { id: 'daifuku', name: 'ダイフク', full: '白玉 ダイフク', pos: 'GK', age: 26, job: '和菓子屋の若旦那', stats: { spd: 24, sht: 24, pas: 34, def: 62, sta: 40 },
    ...
    { id: 'hikaru', name: 'ヒカル', full: '星野 ヒカル', pos: 'FW', age: 23, job: '配信者', stats: { spd: 58, sht: 58, pas: 30, def: 18, sta: 44 },
    ...
    { id: 'ume', name: 'ウメ', full: '梅田 ウメ', pos: 'DF', age: 55, job: '主婦（元なぎなた日本一）', stats: { spd: 40, sht: 26, pas: 42, def: 68, sta: 46 },
  ...
  const AWAY = [
    ...
    { id: 'fuigo', name: 'フイゴ', pos: 'DF', stats: { spd: 50, sht: 32, pas: 42, def: 52, sta: 62 }, look: look(AWAY_KIT, 'light', '#6a4020', '#4a2a14', 'short') },
    { id: 'tetsuyama', name: '鉄山', pos: 'DF', stats: { spd: 50, sht: 52, pas: 48, def: 70, sta: 72 }, look: look(AWAY_KIT, 'tan', '#2a1a24', '#140c12', 'short', 'goggles', 'big'),
      full: '鉄山 剛', trait: '鋼の壁', traitDesc: 'タックルの成功率が高い。', bio: 'ヤマオロシ鉄工団の主将。溶接の腕も一流。', age: 29, job: '溶接工' },
    { id: 'kotaro', name: '鋼太郎', pos: 'DF', stats: { spd: 34, sht: 36, pas: 36, def: 66, sta: 70 }, look: look(AWAY_KIT, 'mid', '#2a1a24', '#140c12', 'helmet', null, 'big'),
    ...
    { id: 'rinko', name: '燐子', pos: 'MF', stats: { spd: 56, sht: 44, pas: 54, def: 44, sta: 58 }, look: look(AWAY_KIT, 'light', '#ff8a3a', '#c05a1a', 'ponytail') },
    ...
    { id: 'ootsuchi', name: '大槌', pos: 'MF', stats: { spd: 40, sht: 50, pas: 50, def: 56, sta: 66 }, look: look(AWAY_KIT, 'tan', '#2a1a24', '#140c12', 'spiky', null, 'big') },
    { id: 'robata', name: '炉端', pos: 'MF', stats: { spd: 48, sht: 46, pas: 48, def: 46, sta: 60 }, look: look(AWAY_KIT, 'mid', '#3a2a24', '#241814', 'short', 'band') },
  ...
  window.Data = { HOME, AWAY, FORMATIONS, ORDERS, HOME_KIT, AWAY_KIT, COMBOS, DEFAULT_LINEUP };
})();
